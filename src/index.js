...
Andor.prototype.is = function (input, ...rest) {
  return this.and(input, ...rest);
};
Andor.prototype.has = function(input, ...rest) {
  return this.and(input, ...rest);
};
Andor.prototype.and = function(input, ...rest) {
  this.ands.push(and(input, ...rest));
  return this;
};
Andor.prototype.or = function(input, ...rest) {
  this.ors.push(or(input, ...rest));
  return this;
};
Andor.prototype.isTrue = function () {
